...
This repo carries the five project-specific agent layers as tracked, reviewable files:
...
| **Layer 5 - Plugins** | Distribution manifest for the bundle | [`plugins/open-design-agent-kit/plugin.json`](plugins/open-design-agent-kit/plugin.json) |
