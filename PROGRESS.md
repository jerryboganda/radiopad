...
- **Tests**: +5 (`Launcher_EnvAllowlist_PassesGeminiApiKey` incl. trust var; `--skip-trust` in gemini args; `CliProviderSeedTests` seed/idempotency/rename-backfill/operator-name-preserved). Full backend suite green.
