...
- AI gateway tests must cover disabled/blocked provider rejection, audit recording, `ContainsPhi` computation, and allowed routing under the current unrestricted PHI-routing policy.
