...
/// <summary>
/// The OPTIONAL on-device report formatter (dictation brief §2.2). <see cref="Available"/>
...
public interface ILocalReportFormatter : IDictationFormatter
{
    ...
    /// reachable would have silently rerouted every desktop report draft to the local formatter. Two different
